...
public class RedisClientHelper {
  ...
  public static RedisClient getShared(Vertx vertx ) {
    return getShared(vertx, DEFAULT_POOL_NAME);
  }

  public static RedisClient getShared(Vertx vertx, String poolName) {
    synchronized (vertx) {
